    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                @endif
                <li class="breadcrumb-item active">Columns</li>
            </ol>
        </nav>
    </div>
    <div class="btn-group">
        <a href="{{ route('admin.rows.index', $entity) }}" class="btn btn-success">
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card" x-data="columnForm()">
            ...
            <div class="card-body">
                <form action="{{ route('admin.columns.store', $entity) }}" method="POST" id="addColumnForm">
                    @csrf

    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.columns.index.package', $package) }}">{{ $package->name }}</a></li>
...
<div class="card">
    <div class="card-body">
        <!-- Search Form -->
        <form action="{{ route('admin.rows.index.package', $package) }}" method="GET" class="mb-4">
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        @if($search ?? false)
                        <a href="{{ route('admin.rows.index.package', $package) }}" class="btn btn-outline-secondary" title="Clear search">
        ...
        <div class="text-center py-5">
            ...
            <a href="{{ route('admin.rows.index.package', $package) }}" class="btn btn-secondary">
...
<div class="modal fade" id="addRowModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.rows.store.package', $package) }}" method="POST">
                @csrf
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.rows.import.package', $package) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
